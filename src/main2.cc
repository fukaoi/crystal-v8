...
int main(int argc, char const *argv[])
{
  ...
  eval("1 + 1");
  eval("new Date()");
  eval("const a = 10;let b = 10;a + b;");
  eval("class Person {constructor(name) {this.name = name;}sayHello() {return ('Hello, Im' + this.getName());}getName() {return this.name;}}; new Person('山田敬三').sayHello();");
  eval("const fn = function(a){return a * 999};fn(10)");
  eval("const fn2 = (a)=> {return a * 555};fn2(10)");
  destroy();
  return 0;
}
